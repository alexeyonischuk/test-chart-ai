...
declare module '../js/chartiq.js' {
  ...
  export namespace CIQ.UI {
    ...
    class Chart {
       ...
       *
       * @param uiContext The chart user interface context.
       * @returns A function that sets the class of the UI context.
       *
       * @since 8.8.0
       */
    ...
    class Multichart {
       ...
       *
       * @param stx A reference to the chart engine.
       * @returns A function that can be called to unfreeze the engine.
       *
       * @since 8.8.4
       */
    ...
    class DialogContentTag extends CIQ.UI.BaseComponent {
       ...
       * @returns Array containing all tab navigable elements.
       *
       * @since 8.8.0
       */
