 ...
 * @param {number} partner	Trading Central API partner number
 */
 ...
 *
 * @param {CIQ.ChartEngine} stx Updated chart engine reference
 */
CIQ.AnalystViews.prototype.changeChartEngine = function (stx) {
	this.stx = stx;
	this.panel = stx.chart.panel;
};
