...
// Parser.random is commented out since it is not used and not truly random. Removes security warnings.
...
var Parser = function () {
	...
	// Math.random isn't truly random! We don't need it so just comment it out.
	// function random(a) {
...
__js_standard_equations_(typeof window !== "undefined" ? window : global);
